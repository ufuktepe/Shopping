...
VISITORS = {'New_Visitor': 0, 'Other': 0, 'Returning_Visitor': 1}
...
def load_data(filename):
    ...
    # Loop over each row in the csv and populate the evidence and labels lists
...
def evaluate(labels, predictions):
    ...
    """
    # Get true negative, false positive, false negative, true positive counts
